...
SELECT gender FROM employees
GROUP BY gender;
# you can add order by after the group by
...
# ------------------------------------------------------------
# whatever you select, you need to group by.
# you can change order of the grouping either by the oder by clause or by rearranging the group by.
